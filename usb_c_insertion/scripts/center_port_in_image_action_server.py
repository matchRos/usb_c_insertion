...
class CenterPortInImageActionServer:
    ...
    def _refresh_usb_card_selector(self) -> None:
        ...
        with self._lock:
            ...
            self._latest_detection = None
        rospy.loginfo(
            "[usb_c_insertion] event=center_port_usb_card_selector_updated target_card_index=%d target_point=%s require_connector=%s order_axis=%s order_direction=%s expected_card_count=%d estimated_slot_requires_complete=%s",
